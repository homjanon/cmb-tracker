...
基于 **谷子地（ice_招行谷子地）投资风格** 的五维选股模型，每日盘后自动抓取招商银行、工商银行、建设银行、农业银行、中国银行、宁波银行的行情与财务数据，计算五维评分、买入信号与买入区间，并发布到 GitHub Pages。
...
| 代码 | 银行 | 备注 |
|------|------|------|
| 600036 | 招商银行 | 零售之王，五维标杆 |
| 601398 | 工商银行 | 国有大行 |
| 601939 | 建设银行 | 国有大行 |
| 601288 | 农业银行 | 县域存款优势 |
| 601988 | 中国银行 | 海外布局 |
| 002142 | 宁波银行 | 高 ROE 股份行 |
